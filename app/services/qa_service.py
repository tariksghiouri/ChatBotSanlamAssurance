...
from app.services.persistence.file_persistence_strategy import FilePersistenceStrategy
from app.services.persistence.mongo_persistence_strategy import MongoPersistenceStrategy
...
class QAService:
    def __init__(self):
        ...
        # self.persistence_strategy = FilePersistenceStrategy(Path("chat_histories"))
        self.persistence_strategy = MongoPersistenceStrategy(
    ...
    def get_answer(self, question: str, session_id: str) -> str:
        chat_history = self.persistence_strategy.load_chat_history(session_id)
        ...
        self.persistence_strategy.save_chat_history(session_id, chat_history)
